...
- The manual-IR warning now uses a standard Windows message box whose title
  contains the complete decision for automatic NVDA speech, with OK as both the
  focused and default action.
